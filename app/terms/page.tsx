    ...
    <Layout>
      <div className="min-h-screen bg-[var(--color-surface)] py-12 px-4">
        <div className="max-w-4xl mx-auto bg-[var(--color-card-bg)] rounded-lg shadow-md p-8">
          <h1 className="text-3xl font-bold text-[var(--color-text-strong)] mb-6">服务条款</h1>
          ...
          <div className="prose max-w-none space-y-6 text-[var(--color-text)]">
            <section>
              <h2 className="text-2xl font-semibold text-[var(--color-text-strong)] mb-4">1. 接受条款</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[var(--color-text-strong)] mb-4">2. 服务描述</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[var(--color-text-strong)] mb-4">3. 用户账户</h2>
              <h3 className="text-xl font-medium text-[var(--color-text-strong)] mb-3">3.1 账户注册</h3>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[var(--color-text-strong)] mb-4">4. 使用规则</h2>
              <p>您同意不会：</p>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[var(--color-text-strong)] mb-4">5. 知识产权</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[var(--color-text-strong)] mb-4">6. 用户内容</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[var(--color-text-strong)] mb-4">7. 免责声明</h2>
              <h3 className="text-xl font-medium text-[var(--color-text-strong)] mb-3">7.1 服务&ldquo;按现状&rdquo;提供</h3>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[var(--color-text-strong)] mb-4">8. 责任限制</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[var(--color-text-strong)] mb-4">9. 赔偿</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[var(--color-text-strong)] mb-4">10. 服务终止</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[var(--color-text-strong)] mb-4">11. 第三方服务</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[var(--color-text-strong)] mb-4">12. 修改条款</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[var(--color-text-strong)] mb-4">13. 适用法律</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[var(--color-text-strong)] mb-4">14. 可分割性</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[var(--color-text-strong)] mb-4">15. 完整协议</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[var(--color-text-strong)] mb-4">16. 联系我们</h2>
              <p>
