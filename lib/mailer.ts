...
<body style="font-family: Arial, 'Microsoft YaHei', sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(135deg, #F59E0B 0%, #D97706 100%); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
    <h1 style="color: white; margin: 0; font-size: 24px;">【奇门遁甲】邮箱验证</h1>
  </div>
  
  <div style="background: #ffffff; padding: 40px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 10px 10px;">
    <p style="font-size: 16px; margin-bottom: 20px;">
      您好${userName ? `，${userName}` : ""}，感谢注册【奇门遁甲】！
    </p>
    ...
    <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e7eb; text-align: center;">
      <p style="font-size: 12px; color: #999; margin: 0;">
        如有任何疑问，请联系：<a href="mailto:support@example.com" style="color: #F59E0B;">support@example.com</a>
      </p>
      <p style="font-size: 11px; color: #ccc; margin-top: 20px;">
        © ${new Date().getFullYear()} 奇门遁甲. 保留所有权利.
      </p>
    </div>
  </div>
</body>
...
如有任何疑问，请联系：support@example.com
...
export async function sendVerificationEmail(
  ...
  try {
    if (smtpConfigured) {
      ...
      console.log("=== 验证邮件（预览）===");
      console.log("收件人:", to);
      console.log("主题: 【奇门遁甲】邮箱验证：点击确认，激活您的账户");
